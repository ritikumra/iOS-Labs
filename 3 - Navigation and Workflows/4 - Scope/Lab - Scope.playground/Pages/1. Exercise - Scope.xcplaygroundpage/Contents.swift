...
// foo is a local constant with limited scope inside the for loop.
...
// x is defined globally whereas foo is defined locally therefore scope of x is more than that of foo which can be accesed globally
...
greeting(greeting: "Hi there", name: "Riti")
greeting(greeting: nil, name: "Riti")
