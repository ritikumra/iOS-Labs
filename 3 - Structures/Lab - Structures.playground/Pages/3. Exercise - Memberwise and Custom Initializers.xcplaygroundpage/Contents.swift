...
var myLocation = GPS(latitude: 51.50, longitude: 0.125226);
print(myLocation);
...
var favoriteBook = Book(title: "book1", author: "autho", pages: 120, price: 129);
print(favoriteBook);
...
var firstLaptop = Laptop(yearPurchased: 2021);
 ...
 */
struct Height{
    var heightInInches,heightInCentimeter:Double;
    
    init(heightInInches: Double) {
        self.heightInInches = heightInInches
        self.heightInCentimeter = heightInInches * 2.54;
    }
    init(heightInCentimeter:Double){
        self.heightInCentimeter = heightInCentimeter
        self.heightInInches = heightInCentimeter / 2.54;
    }
}
...
var secondHeight = Height(heightInCentimeter: 165.1);
print(secondHeight);
...
var firstHeight = Height(heightInInches: 200);
print(firstHeight);
