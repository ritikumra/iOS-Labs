...
var first = Rectangle(width: 20, height: 20);
print(first.area);
...
struct Height {
    var heightInInches: Double{
        didSet{
            ...
            print("\(oldValue) changed to \(heightInInches)")
        }
    }
    var heightInCentimeters: Double{
        didSet{
            ...
            print("\(oldValue) changed to \(heightInCentimeters)")
        }
    }
...
var h = Height(heightInInches: 20);
print("heightInInches \(h.heightInInches) and \(h.heightInCentimeters)");
h.heightInInches = 21;
print("heightInInches \(h.heightInInches) and \(h.heightInCentimeters)");
/*:
